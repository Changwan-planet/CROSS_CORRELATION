...
path="/home/changwan/CROSS_CORRELATION/x_h_signal.txt"

path2="/home/changwan/CROSS_CORRELATION/crrl_output.txt"
path3="/home/changwan/CROSS_CORRELATION/h_cut.txt"

#path="/home/changwan/HILBERT/IFFT_output.txt"
path4="/home/changwan/GPR/A_SCOPE_GPR.txt"
...
plt.subplot(313)
plt.plot(data2_2.loc[:,0], 'r')
plt.grid()

plt.subplot(311)
plt.plot(data4_2.loc[:,0],'g')
plt.grid()
